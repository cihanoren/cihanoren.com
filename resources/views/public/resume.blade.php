...
<section class="max-w-7xl mx-auto px-6 pt-24 pb-32">
    ...
    <div class="mb-16">
        ...
        <div class="space-y-0">
            <div class="group relative grid grid-cols-[auto_1fr] md:grid-cols-[200px_auto_1fr] gap-5 md:gap-8 pb-4">
                ...
                {{-- 2. Timeline Line & Dot (No connecting line since it's a single item currently) --}}
                <div class="relative flex flex-col items-center w-6">
                ...
                <div class="pt-0.5">
                    ...
                    <h3 class="text-white font-bold text-xl mb-2">University Name</h3>
                    
                    <div class="flex items-center flex-wrap gap-2 text-sm mb-2">
                        <span class="flex items-center gap-1.5 font-medium text-indigo-400">
                            <svg class="w-4 h-4 text-indigo-400/70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0v6m0 0H9m3 0h3"/></svg>
                            Department
                        </span>
                    </div>
                </div>
